...
Теперь наполните два других файла (```card_contents_2``` и ```card_contents_3```) с точно такими же размерами и цветами. Текст для заголовка и краткого описания, можете придумать свой или взять из Википедии.
